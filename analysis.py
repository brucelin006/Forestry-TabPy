...
def analyze(path_to_file):
    ...
    # Filter out irrelavant or meaningless columns, for example columns that end with Key, Code, limit and Class
    filtered_columns = filter_columns(df)
    # Examine the correlations of the filtered columns
